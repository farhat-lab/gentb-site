    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pipeline', models.ForeignKey(to='pipeline.Pipeline', on_delete=models.CASCADE)),
            ],
        ),
        migrations.CreateModel(
            name='PredictStrain',
        ...
        migrations.AddField(
            ...
            name='dataset',
            field=models.ForeignKey(related_name='strains', to='predict.PredictDataset', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='predictstrain',
            name='file_one',
            field=models.ForeignKey(related_name='link_a', blank=True, to='uploads.UploadFile', null=True, on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='predictstrain',
            name='file_two',
            field=models.ForeignKey(related_name='link_b', blank=True, to='uploads.UploadFile', null=True, on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='predictstrain',
            name='pipeline',
            field=models.ForeignKey(to='pipeline.Pipeline', on_delete=models.CASCADE),
        ),
        migrations.AddField(
            model_name='predictstrain',
            name='piperun',
            field=models.ForeignKey(blank=True, to='pipeline.PipelineRun', null=True, on_delete=models.CASCADE),
        ),
    ]
