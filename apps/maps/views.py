            ...
            [
                {
                 ...
                 #       "inh_rr": get_health(country).inh_rr,
                 #       "rif_rr": get_health(country).rif_rr,
                 #       "pza_rr": get_health(country).pza_rr,
                 #       "emb_rr": get_health(country).emb_rr,
                 #       "str_rr": get_health(country).str_rr,
                 #       "eth_rr": get_health(country).eth_rr,
                 #       "kan_rr": get_health(country).kan_rr,
                 #       "cap_rr": get_health(country).cap_rr,
                 #       "amk_rr": get_health(country).amk_rr,
                 #       "cip_rr": get_health(country).cip_rr,
                 #       "levo_rr": get_health(country).levo_rr,
                 #       "oflx_rr": get_health(country).oflx_rr,
                 #       "pas_rr": get_health(country).pas_rr
                    }
